...
(2) DEFAULT NULL,
  `tipo` char
(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` varchar
(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `portada` varchar
(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(11) unsigned NOT NULL AUTO_INCREMENT,
  `categoria` varchar
(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY
(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(11) unsigned NOT NULL AUTO_INCREMENT,
  `nombre` varchar
(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `apodo` varchar
(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `password` varchar
(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `email` varchar
(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY
(`id`)
