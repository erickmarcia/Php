  ...
  <div class="container-fluid blog">
    <section class="row d-flex justify-content-between container__news">
      <div class="col-12 col-xl-7 news p-0">
        <div class="d-xl-flex">
          <?php
            $principal = $blog->showArticles('p', 1);
            if (!empty($principal)) {
          ...
          <div class="col-12 col-xl-4 relevant">
              ...
              <div class="relevant__body">
                <?php
                $relevantes = $blog->showArticles('r', 2);
                if (!empty($relevantes)) {
                  foreach ($relevantes as $r) { ?>
                    <article class=" mb-5">
                      ...
                      <em class="relevant__article--public">Publicador por <?=$r['username'];?></em>
                    </article>
                  <?php }
                } ?>
              </div>
      ...
      <section class="row d-flex justify-content-between">
          <div class="col-12 col-xl-8">
              ...
              <?php
            //   mostrar articulos '' mostrar todos
                $ultimos = $blog->showArticles('', 10);
                if (!empty($ultimos)) {
                  foreach ($ultimos as $r) { ?>
                    <div class="post">
                      ...
                      <div class="post__description">
                        ...
                        <em class="post__description--em">Publicador por: <strong><?=$r['username']; ?></strong></em>
                      </div>
                    </div>
                  <?php }
                }
